      ...
      <div>
        ...
        <Container>
          ...
          <div style={{fontWeight: 'bold'}}>
            ...
            <ul style={{fontWeight: 'normal', listStyle: 'none', margin: '0px', padding: '0px', textAlign: 'center'}}>{collaborators}</ul>
          </div>
          <div style={{fontWeight: 'bold'}}>
            Accepted collaborators:
            <ul style={{fontWeight: 'normal', listStyle: 'none', margin: '0px', padding: '0px', textAlign: 'center'}}>{accepted}</ul>
          </div>
        </Container>
      </div>
    );
